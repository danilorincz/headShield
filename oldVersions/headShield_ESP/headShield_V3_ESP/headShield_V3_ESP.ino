...
#include "C:\Users\user\Desktop\headShield\3_programming\headShield_ESP\headShield_V3_ESP\webpage.h"
#include "C:\Users\user\Desktop\headShield\3_programming\headShield_ESP\headShield_V3_ESP\timer.h"
#include <Arduino.h>
...
const int piezoChannel = 3;
const int vibrationPin = 17;

//? FAN_SPEED
const int tachoPin_1 = 15;
const int tachoPin_2 = 35;
const int tachoPin_3 = 36;
const int tachoPin_4 = 39;

class Tachometer
{
public:
  unsigned int RPM; //? percent
  int pin;
  ...
  unsigned int getRPM()
  {
    RPM = 60 * 1000 * 1000 / getHalfPeriodTime() * 4;
    return RPM;
  }
  void begin()
  {
...
private:
  unsigned int getHalfPeriodTime()
  {
...
Tachometer fan_1(tachoPin_1);
Tachometer fan_2(tachoPin_2);
Tachometer fan_3(tachoPin_3);
Tachometer fan_4(tachoPin_4);
...
//! LOOP
Timer measureSpeedTimer(1000000);
void loop()
{
  server.handleClient();
  ...
  if (measureSpeedTimer.timeElapsed())
  {
    fan_1.getRPM();
    fan_2.getRPM();
    fan_3.getRPM();
...
void printFanRPM()
{
  Serial.println("FAN SPEED______________");
  Serial.print("Fan 1: ");
